...
namespace Resto.Front.Api.TestPlugin.CookingPriority
{
    public sealed partial class CookingPriorityView
    {
        ...
        private void ChangeCookingPriority(IOrder order, int cookingPriority, bool isTopCookingPriority)
        {
            ...
            PluginContext.Operations.ChangeCookingPriority(cookingPriority, isTopCookingPriority, order, PluginContext.Operations.GetDefaultCredentials());
