...
namespace Resto.Front.Api.TestPlugin.Restaurant
{
    public sealed partial class StreetView
    {
        ...
        private void BtnRenameClick(object sender, RoutedEventArgs e)
        {
            ...
            PluginContext.Operations.ChangeStreetName(txtBox.Text, street, PluginContext.Operations.GetDefaultCredentials());
        ...
        private void BtnUndeleteClick(object sender, RoutedEventArgs e)
        {
            ...
            PluginContext.Operations.DeleteOrRestoreStreet(false, street, PluginContext.Operations.GetDefaultCredentials());
