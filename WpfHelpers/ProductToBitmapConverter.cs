        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            switch (value)
            {
                case ProductModel model when model.Product.HasMenuImage:
                    return ImageBytesToBitmapConverter.CreateBitmap(model.Product.TryGetProductMenuImage());
                case ProductGroupModel model when model.ProductGroup.HasMenuImage:
                    return ImageBytesToBitmapConverter.CreateBitmap(model.ProductGroup.TryGetProductGroupMenuImage());
                default:
                    return null;
            }
        }
